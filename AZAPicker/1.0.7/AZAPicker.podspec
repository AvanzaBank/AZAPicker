...
AZAPicker is a configurable and simple horizontal picker for iOS apps written entirely in Swift.
  ...
  s.author           = { 'Viktor Rutberg' => 'viktor.rutberg@avanza.se', 'Tommy Malmström' => 'tommy.malmstrom@avanza.se', 'Askia Linder' => 'askia.linder@avanza.se', 'Carl Lundstedt' => 'carl.lundstedt@avanza.se' }
